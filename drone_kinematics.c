 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Apr 27 20:41:25 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME drone_kinematics
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void drone_kinematics_Outputs_wrapper(const int32_T *in,
			int32_T *out);
/*====================*
 * S-function methods *
 *====================*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    drone_kinematics_Outputs_wrapper(in, out);
